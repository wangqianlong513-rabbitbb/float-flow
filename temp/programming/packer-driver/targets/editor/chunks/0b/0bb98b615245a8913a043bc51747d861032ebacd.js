    ...
    execute: function () {
      ...
      _export("VictoryPoster", VictoryPoster = (_dec = ccclass('VictoryPoster'), _dec(_class = class VictoryPoster extends Component {
        ...
        onLoad() {
          ...
          const pg = poster.addComponent(Graphics); // Deep sapphire navy glassmorphic background
        ...
        createRouteShowcase(parent) {
          ...
          const g = showcaseRoot.addComponent(Graphics); // Draw a mini 3x3 isometric stone tile board
          ...
          const p4 = getCoordPos(2, 2); // Magenta outer glow
        ...
        createStatsAndQR(parent) {
          ...
          const qg = qrRoot.addComponent(Graphics); // Glassmorphic QR box (84 x 84)
