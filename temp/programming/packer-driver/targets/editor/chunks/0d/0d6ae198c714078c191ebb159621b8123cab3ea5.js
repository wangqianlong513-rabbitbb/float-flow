    ...
    execute: function () {
      ...
      _export("ReviveModal", ReviveModal = (_dec = ccclass('ReviveModal'), _dec(_class = class ReviveModal extends Component {
        ...
        onLoad() {
          ...
          const dg = dialog.addComponent(Graphics); // Dark glassmorphic background
        ...
        createCrashSitePreview(parent) {
          ...
          const g = previewRoot.addComponent(Graphics); // Draw a mini 3x3 isometric grid
          ...
          const sg = shockRoot.addComponent(Graphics); // Warning halo
        ...
        createWeChatShareButton(parent) {
          ...
          const g = shareBtn.addComponent(Graphics); // Vibrant WeChat Green Background (#10B981 / #07C160)
